...
public final class QuantityDialogBinding implements ViewBinding {
  ...
  private QuantityDialogBinding(@NonNull LinearLayout rootView, @NonNull Spinner quantitySpinner) {
  ...
  public static QuantityDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new QuantityDialogBinding((LinearLayout) rootView, quantitySpinner);
    }

...
public final class ActivityExistingPatientsBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityExistingPatientsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityExistingPatientsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_existing_patients, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityExistingPatientsBinding bind(@NonNull View rootView) {

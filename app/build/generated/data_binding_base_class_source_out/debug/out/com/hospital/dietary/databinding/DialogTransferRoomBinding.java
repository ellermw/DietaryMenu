...
public final class DialogTransferRoomBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static DialogTransferRoomBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogTransferRoomBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_transfer_room, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogTransferRoomBinding bind(@NonNull View rootView) {

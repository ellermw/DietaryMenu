...
public final class ItemUserBinding implements ViewBinding {
  ...
  private ItemUserBinding(@NonNull LinearLayout rootView, @NonNull TextView fullNameText,
      @NonNull TextView roleText, @NonNull TextView statusText, @NonNull TextView usernameText) {
  ...
  public static ItemUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemUserBinding((LinearLayout) rootView, fullNameText, roleText, statusText,
          usernameText);
    }

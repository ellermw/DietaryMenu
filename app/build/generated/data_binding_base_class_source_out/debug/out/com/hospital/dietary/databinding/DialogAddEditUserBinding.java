...
public final class DialogAddEditUserBinding implements ViewBinding {
  ...
  private DialogAddEditUserBinding(@NonNull LinearLayout rootView, @NonNull CheckBox activeCheckBox,
  ...
  public static DialogAddEditUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogAddEditUserBinding((LinearLayout) rootView, activeCheckBox, fullNameEditText,

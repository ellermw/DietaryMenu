...
public final class ItemPatientListBinding implements ViewBinding {
  ...
  private ItemPatientListBinding(@NonNull LinearLayout rootView, @NonNull TextView patientDietText,
  ...
  @NonNull
  public static ItemPatientListBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemPatientListBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_patient_list, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemPatientListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemPatientListBinding((LinearLayout) rootView, patientDietText,
          patientLocationText, patientMealStatusText, patientNameText, selectionCheckBox);
    }

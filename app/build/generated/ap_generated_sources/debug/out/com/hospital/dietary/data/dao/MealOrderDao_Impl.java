  ...
  public MealOrderDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMealOrderEntity = new EntityInsertionAdapter<MealOrderEntity>(__db) {
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        final Long _tmp = DateConverter.dateToTimestamp(entity.orderDate);
        if (_tmp == null) {
        ...
        if (entity.createdBy == null) {
          ...
          statement.bindString(6, entity.createdBy);
        }
        final Long _tmp_2 = DateConverter.dateToTimestamp(entity.timestamp);
        if (_tmp_2 == null) {

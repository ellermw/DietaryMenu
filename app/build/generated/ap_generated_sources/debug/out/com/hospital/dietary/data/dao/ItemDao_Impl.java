  ...
  public ItemDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfItemEntity = new EntityInsertionAdapter<ItemEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `items` (`item_id`,`name`,`category`,`description`,`is_ada_friendly`) VALUES (nullif(?, 0),?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(5, entity.getIsAdaFriendly());
      }
    };
    ...
    this.__updateAdapterOfItemEntity = new EntityDeletionOrUpdateAdapter<ItemEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `items` SET `item_id` = ?,`name` = ?,`category` = ?,`description` = ?,`is_ada_friendly` = ? WHERE `item_id` = ?";
      }
      ...
      public List<ItemEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final int _tmpIsAdaFriendly;
            _tmpIsAdaFriendly = _cursor.getInt(_cursorIndexOfIsAdaFriendly);
            _item.setIsAdaFriendly(_tmpIsAdaFriendly);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  public ItemEntity getItemById(final long itemId) {
    ...
    try {
      ...
      if (_cursor.moveToFirst()) {
        ...
        final int _tmpIsAdaFriendly;
        _tmpIsAdaFriendly = _cursor.getInt(_cursorIndexOfIsAdaFriendly);
        _result.setIsAdaFriendly(_tmpIsAdaFriendly);
      } else {
        _result = null;
      }
      return _result;

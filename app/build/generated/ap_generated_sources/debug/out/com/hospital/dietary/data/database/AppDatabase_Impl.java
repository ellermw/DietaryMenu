  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `patient_info` (`patient_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `patient_first_name` TEXT, `patient_last_name` TEXT, `wing` TEXT, `room_number` TEXT, `diet_type` TEXT, `diet` TEXT, `ada_diet` INTEGER NOT NULL DEFAULT 0, `fluid_restriction` TEXT, `texture_modifications` TEXT, `mechanical_chopped` INTEGER NOT NULL DEFAULT 0, `mechanical_ground` INTEGER NOT NULL DEFAULT 0, `bite_size` INTEGER NOT NULL DEFAULT 0, `bread_ok` INTEGER NOT NULL DEFAULT 0, `nectar_thick` INTEGER NOT NULL DEFAULT 0, `pudding_thick` INTEGER NOT NULL DEFAULT 0, `honey_thick` INTEGER NOT NULL DEFAULT 0, `extra_gravy` INTEGER NOT NULL DEFAULT 0, `meats_only` INTEGER NOT NULL DEFAULT 0, `breakfast_complete` INTEGER NOT NULL DEFAULT 0, `lunch_complete` INTEGER NOT NULL DEFAULT 0, `dinner_complete` INTEGER NOT NULL DEFAULT 0, `breakfast_npo` INTEGER NOT NULL DEFAULT 0, `lunch_npo` INTEGER NOT NULL DEFAULT 0, `dinner_npo` INTEGER NOT NULL DEFAULT 0, `breakfast_items` TEXT, `lunch_items` TEXT, `dinner_items` TEXT, `breakfast_juices` TEXT, `lunch_juices` TEXT, `dinner_juices` TEXT, `breakfast_drinks` TEXT, `lunch_drinks` TEXT, `dinner_drinks` TEXT, `created_date` INTEGER DEFAULT CURRENT_TIMESTAMP, `modified_date` INTEGER DEFAULT CURRENT_TIMESTAMP)");
        db.execSQL("CREATE UNIQUE INDEX IF NOT EXISTS `index_patient_info_wing_room_number` ON `patient_info` (`wing`, `room_number`)");
        db.execSQL("CREATE TABLE IF NOT EXISTS `items` (`item_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT, `category` TEXT, `description` TEXT, `is_ada_friendly` INTEGER NOT NULL DEFAULT 0, `created_date` INTEGER DEFAULT CURRENT_TIMESTAMP)");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '1d3bbc63612a2d4ebe4691c4b89f2ff9')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsPatientInfo = new HashMap<String, TableInfo.Column>(36);
        ...
        _columnsPatientInfo.put("modified_date", new TableInfo.Column("modified_date", "INTEGER", false, 0, "CURRENT_TIMESTAMP", TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsItems.put("created_date", new TableInfo.Column("created_date", "INTEGER", false, 0, "CURRENT_TIMESTAMP", TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "1d3bbc63612a2d4ebe4691c4b89f2ff9", "0fba0ce80641930f3094296fbb50ef8c");

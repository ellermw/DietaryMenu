...
public class ItemDAO {
    ...
    // ===== MISSING CATEGORY METHODS - ADD THESE =====
    ...
    // Patient and order management methods
    public long savePatient(String name, String room, String wing, String diet) {
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        ContentValues values = new ContentValues();
        ...
        Cursor cursor = db.rawQuery(query, new String[]{diet});
        if (cursor.moveToFirst()) {
